    ...
    for data_struct in data["x-\$defs"]
        ...
        for field in data_struct.second["properties"]
            ...
            if "type" in keys(field.second)
                new_field["type"] = field.second["type"]
            end
            if "default" in keys(field.second)
                new_field["default"] = field.second["default"]
            end
...
generate_file(
    "src/descriptors/portfolio_structs.json",
    "C:/Users/jpotts/Documents/SiennaInvestSchema_openapi.json",
)
