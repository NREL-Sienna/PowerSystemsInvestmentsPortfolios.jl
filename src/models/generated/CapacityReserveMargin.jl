...
function CapacityReserveMargin(; name, target_year=2050, internal=InfrastructureSystemsInternal(), id, capacity_reserve_fraction=0.0, ext=Dict(), available, )
    CapacityReserveMargin(name, target_year, internal, id, capacity_reserve_fraction, ext, available, )
end
