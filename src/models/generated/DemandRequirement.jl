...
function DemandRequirement{T}(; name, value_of_lost_load, power_systems_type, peak_demand_mw=0.0, internal=InfrastructureSystemsInternal(), ext=Dict(), region, available=true, ) where T <: PSY.StaticInjection
    DemandRequirement{T}(name, value_of_lost_load, power_systems_type, peak_demand_mw, internal, ext, region, available, )
end
