...
function TechnologyFinancialData(; internal=InfrastructureSystemsInternal(), interest_rate=0.0, capital_recovery_period, technology_base_year, )
    TechnologyFinancialData(internal, interest_rate, capital_recovery_period, technology_base_year, )
end
