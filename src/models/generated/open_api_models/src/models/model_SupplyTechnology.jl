...
Base.@kwdef mutable struct SupplyTechnology <: OpenAPI.APIModel
    ...
    function SupplyTechnology(
        ...
        OpenAPI.validate_property(
            SupplyTechnology,
            Symbol("minimum_required_capacity"),
            minimum_required_capacity,
        )
        OpenAPI.validate_property(
            SupplyTechnology,
...
const _property_types_SupplyTechnology = Dict{Symbol, String}(
    ...
    Symbol("minimum_required_capacity") => "Float64",
    ...
    Symbol("maximum_capacity") => "Float64",
    Symbol("cluster") => "Int64",
