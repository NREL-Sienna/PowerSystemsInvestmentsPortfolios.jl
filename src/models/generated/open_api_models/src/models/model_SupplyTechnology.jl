...
Base.@kwdef mutable struct SupplyTechnology <: OpenAPI.APIModel
    ...
    function SupplyTechnology(base_power, heat_rate_mmbtu_per_mwh, outage_factor, prime_mover_type, cofire_level_min, capital_costs, max_capacity, dn_time, lifetime, cofire_start_max, available, co2, cofire_start_min, name, ramp_dn_percentage, min_capacity, id, initial_capacity, financial_data, start_fuel_mmbtu_per_mw, operation_costs, fuel, power_systems_type, cofire_level_max, internal, ext, balancing_topology, region, ramp_up_percentage, base_year, unit_size, min_generation_percentage, start_cost_per_mw, up_time, )
        ...
        return new(base_power, heat_rate_mmbtu_per_mwh, outage_factor, prime_mover_type, cofire_level_min, capital_costs, max_capacity, dn_time, lifetime, cofire_start_max, available, co2, cofire_start_min, name, ramp_dn_percentage, min_capacity, id, initial_capacity, financial_data, start_fuel_mmbtu_per_mw, operation_costs, fuel, power_systems_type, cofire_level_max, internal, ext, balancing_topology, region, ramp_up_percentage, base_year, unit_size, min_generation_percentage, start_cost_per_mw, up_time, )
    end
end # type SupplyTechnology

const _property_types_SupplyTechnology = Dict{Symbol,String}(Symbol("base_power")=>"Float64", Symbol("heat_rate_mmbtu_per_mwh")=>"Union{Float64PSYValueCurveDict{ThermalFuelsPSYValueCurve}}", Symbol("outage_factor")=>"Float64", Symbol("prime_mover_type")=>"PrimeMovers", Symbol("cofire_level_min")=>"Union{NothingDict{ThermalFuelsFloat64}}", Symbol("capital_costs")=>"PSYValueCurve", Symbol("max_capacity")=>"Float64", Symbol("dn_time")=>"Float64", Symbol("lifetime")=>"Int", Symbol("cofire_start_max")=>"Union{NothingDict{ThermalFuelsFloat64}}", Symbol("available")=>"Bool", Symbol("co2")=>"Union{Float64Dict{StringFloat64}Dict{ThermalFuelsFloat64}}", Symbol("cofire_start_min")=>"Union{NothingDict{ThermalFuelsFloat64}}", Symbol("name")=>"String", Symbol("ramp_dn_percentage")=>"Float64", Symbol("min_capacity")=>"Float64", Symbol("id")=>"Int64", Symbol("initial_capacity")=>"Float64", Symbol("financial_data")=>"TechnologyFinancialData", Symbol("start_fuel_mmbtu_per_mw")=>"Float64", Symbol("operation_costs")=>"PSYOperationalCost", Symbol("fuel")=>"Union{StringThermalFuelsVector{ThermalFuels}Vector{String}}", Symbol("power_systems_type")=>"String", Symbol("cofire_level_max")=>"Union{NothingDict{ThermalFuelsFloat64}}", Symbol("internal")=>"InfrastructureSystemsInternal", Symbol("ext")=>"Dict", Symbol("balancing_topology")=>"String", Symbol("region")=>"Union{NothingRegionVector{Region}}", Symbol("ramp_up_percentage")=>"Float64", Symbol("base_year")=>"Int", Symbol("unit_size")=>"Float64", Symbol("min_generation_percentage")=>"Float64", Symbol("start_cost_per_mw")=>"Float64", Symbol("up_time")=>"Float64", )
