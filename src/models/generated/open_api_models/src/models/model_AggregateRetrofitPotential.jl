...
Base.@kwdef mutable struct AggregateRetrofitPotential <: OpenAPI.APIModel
    ...
    function AggregateRetrofitPotential(retirement_potential, )
        OpenAPI.validate_property(AggregateRetrofitPotential, Symbol("retirement_potential"), retirement_potential)
        return new(retirement_potential, )
    end
end # type AggregateRetrofitPotential

const _property_types_AggregateRetrofitPotential = Dict{Symbol,String}(Symbol("retirement_potential")=>"Float64", )
