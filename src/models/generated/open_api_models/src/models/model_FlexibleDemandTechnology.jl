...
Base.@kwdef mutable struct FlexibleDemandTechnology <: OpenAPI.APIModel
    ...
    function FlexibleDemandTechnology(max_demand_delay, name, power_systems_type, var_cost_per_mwh, internal, ext, max_demand_advance, demand_energy_efficiency, available, )
        ...
        return new(max_demand_delay, name, power_systems_type, var_cost_per_mwh, internal, ext, max_demand_advance, demand_energy_efficiency, available, )
    end
end # type FlexibleDemandTechnology

const _property_types_FlexibleDemandTechnology = Dict{Symbol,String}(Symbol("max_demand_delay")=>"Float64", Symbol("name")=>"String", Symbol("power_systems_type")=>"String", Symbol("var_cost_per_mwh")=>"PSYValueCurve", Symbol("internal")=>"InfrastructureSystemsInternal", Symbol("ext")=>"Dict", Symbol("max_demand_advance")=>"Float64", Symbol("demand_energy_efficiency")=>"Float64", Symbol("available")=>"Bool", )
