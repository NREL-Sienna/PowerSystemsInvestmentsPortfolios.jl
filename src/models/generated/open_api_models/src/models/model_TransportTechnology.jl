...
Base.@kwdef mutable struct TransportTechnology <: OpenAPI.APIModel
    ...
    function TransportTechnology(
        ...
        OpenAPI.validate_property(
            TransportTechnology,
            Symbol("capital_recovery_factor"),
            capital_recovery_factor,
        )
...
const _property_types_TransportTechnology = Dict{Symbol, String}(
    Symbol("capital_cost") => "PSYValueCurve",
    Symbol("start_region") => "Int64",
    Symbol("available") => "Bool",
    Symbol("name") => "String",
    Symbol("capital_recovery_factor") => "Int64",
    ...
    Symbol("network_id") => "Int64",
    Symbol("maximum_new_capacity") => "Float64",
    Symbol("existing_line_capacity") => "Float64",
    Symbol("wacc") => "Float64",
    Symbol("line_loss") => "Float64",
)
OpenAPI.property_type(::Type{TransportTechnology}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_TransportTechnology[name]))}
...
function OpenAPI.validate_property(::Type{TransportTechnology}, name::Symbol, val) end
