...
Base.@kwdef mutable struct HourlyMatching <: OpenAPI.APIModel
    ...
    function HourlyMatching(name, id, available, qualified_supply, generation_fraction, )
        ...
        return new(name, id, available, qualified_supply, generation_fraction, )
    end
end # type HourlyMatching

const _property_types_HourlyMatching = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("qualified_supply")=>"Vector{Int64}", Symbol("generation_fraction")=>"Float64", )
