...
Base.@kwdef mutable struct HourlyMatching <: OpenAPI.APIModel
    ...
    function HourlyMatching(name, id, available, qualified_supply, qualified_demand, generation_fraction, )
        ...
        OpenAPI.validate_property(HourlyMatching, Symbol("qualified_supply"), qualified_supply)
        OpenAPI.validate_property(HourlyMatching, Symbol("qualified_demand"), qualified_demand)
        OpenAPI.validate_property(HourlyMatching, Symbol("generation_fraction"), generation_fraction)
        return new(name, id, available, qualified_supply, qualified_demand, generation_fraction, )
    end
end # type HourlyMatching

const _property_types_HourlyMatching = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("qualified_supply")=>"Vector{Int64}", Symbol("qualified_demand")=>"Vector{Int64}", Symbol("generation_fraction")=>"Float64", )
