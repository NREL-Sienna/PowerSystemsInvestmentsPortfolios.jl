...
@doc raw"""DemandRequirement
    ...
    - demand_mw::Float64 : Demand value in MW
    - region::Union{NothingRegion} : Region
...
Base.@kwdef mutable struct DemandRequirement <: OpenAPI.APIModel
    ...
    region = nothing # spec type: Union{ Nothing, Union{NothingRegion} }
    available::Union{Nothing, Bool} = nothing

    function DemandRequirement(name, power_systems_type, internal, ext, demand_mw, region, available, )
        ...
        return new(name, power_systems_type, internal, ext, demand_mw, region, available, )
    end
end # type DemandRequirement

const _property_types_DemandRequirement = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("power_systems_type")=>"String", Symbol("internal")=>"InfrastructureSystemsInternal", Symbol("ext")=>"Dict", Symbol("demand_mw")=>"Float64", Symbol("region")=>"Union{NothingRegion}", Symbol("available")=>"Bool", )
