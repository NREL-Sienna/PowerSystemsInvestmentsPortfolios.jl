...
Base.@kwdef mutable struct DemandRequirement <: OpenAPI.APIModel
    ...
    function DemandRequirement(name, available, power_systems_type, demand_mw, region, )
        ...
        return new(name, available, power_systems_type, demand_mw, region, )
    end
end # type DemandRequirement

const _property_types_DemandRequirement = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("available")=>"Bool", Symbol("power_systems_type")=>"String", Symbol("demand_mw")=>"Float64", Symbol("region")=>"DemandRequirementRegion", )
