...
const _property_types_RetrofitPotential = Dict{Symbol,String}(Symbol("internal")=>"InfrastructureSystemsInternal", Symbol("retrofit_potential")=>"Vector{PSYGenerator}", Symbol("ext")=>"Dict", )
