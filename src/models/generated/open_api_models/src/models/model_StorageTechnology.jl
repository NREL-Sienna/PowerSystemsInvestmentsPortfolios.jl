...
Base.@kwdef mutable struct StorageTechnology <: OpenAPI.APIModel
    ...
    function StorageTechnology(
        ...
        OpenAPI.validate_property(
            StorageTechnology,
            Symbol("min_cap_energy"),
            min_cap_energy,
        )
        OpenAPI.validate_property(
            StorageTechnology,
            Symbol("initial_state_of_charge"),
            initial_state_of_charge,
        )
...
const _property_types_StorageTechnology = Dict{Symbol, String}(
    ...
    Symbol("om_costs_energy") => "PSYOperationalCost",
    Symbol("zone") => "Union{NothingInt64Zone}",
    Symbol("prime_mover_type") => "PrimeMovers",
    Symbol("existing_cap_energy") => "Float64",
    Symbol("rsv_cost") => "Float64",
    Symbol("available") => "Bool",
    Symbol("existing_cap_power") => "Float64",
    Symbol("name") => "String",
    Symbol("storage_tech") => "StorageTech",
    Symbol("capital_costs_power") => "PSYValueCurve",
    Symbol("max_duration") => "Float64",
    Symbol("unit_size_power") => "Float64",
    Symbol("id") => "Int64",
    Symbol("min_cap_power") => "Float64",
    Symbol("capital_costs_energy") => "PSYValueCurve",
    Symbol("losses") => "Float64",
    Symbol("eff_down") => "Float64",
    Symbol("rsv_max") => "Float64",
    Symbol("max_cap_power") => "Float64",
    Symbol("power_systems_type") => "String",
    Symbol("internal") => "InfrastructureSystemsInternal",
    Symbol("om_costs_power") => "PSYOperationalCost",
    Symbol("balancing_topology") => "String",
    Symbol("min_cap_energy") => "Float64",
    Symbol("initial_state_of_charge") => "Float64",
    Symbol("eff_up") => "Float64",
    Symbol("unit_size_energy") => "Float64",
    Symbol("ext") => "Dict",
    Symbol("reg_cost") => "Float64",
    Symbol("min_duration") => "Float64",
    Symbol("max_cap_energy") => "Float64",
    Symbol("reg_max") => "Float64",
)
    ...
    if name === Symbol("storage_tech")
        OpenAPI.validate_param(
            ...
            [
                ...
                StorageTech.HGS,
                StorageTech.LAES,
                StorageTech.OTHER_CHEM,
                StorageTech.OTHER_MECH,
                StorageTech.OTHER_THERM,
            ],
        )
    end
end
