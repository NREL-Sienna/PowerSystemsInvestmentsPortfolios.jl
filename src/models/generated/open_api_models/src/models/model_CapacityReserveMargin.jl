...
Base.@kwdef mutable struct CapacityReserveMargin <: OpenAPI.APIModel
    ...
    function CapacityReserveMargin(name, id, available, regions, target_year, capacity_reserve_fraction, )
...
const _property_types_CapacityReserveMargin = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("regions")=>"Vector{Int64}", Symbol("target_year")=>"Int64", Symbol("capacity_reserve_fraction")=>"Float64", )
