...
Base.@kwdef mutable struct EnergyShareRequirements <: OpenAPI.APIModel
    ...
    function EnergyShareRequirements(name, id, available, eligible_regions, generation_fraction, )
...
const _property_types_EnergyShareRequirements = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("eligible_regions")=>"Vector{Int64}", Symbol("generation_fraction")=>"Float64", )
