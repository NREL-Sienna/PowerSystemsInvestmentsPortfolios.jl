...
Base.@kwdef mutable struct TechnologyFinancialData <: OpenAPI.APIModel
    ...
    function TechnologyFinancialData(name, interest_rate, capital_recovery_period, technology_base_year, id, )
...
const _property_types_TechnologyFinancialData = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("interest_rate")=>"Float64", Symbol("capital_recovery_period")=>"Int64", Symbol("technology_base_year")=>"Int64", Symbol("id")=>"Int64", )
