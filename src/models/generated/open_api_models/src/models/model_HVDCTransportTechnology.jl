...
Base.@kwdef mutable struct HVDCTransportTechnology <: OpenAPI.APIModel
    ...
    function HVDCTransportTechnology(base_power, capital_cost, start_region, available, name, id, end_region, financial_data, power_systems_type, angle_limit, internal, ext, resistance, voltage, maximum_new_capacity, base_year, existing_line_capacity, line_loss, )
        ...
        OpenAPI.validate_property(HVDCTransportTechnology, Symbol("internal"), internal)
        OpenAPI.validate_property(HVDCTransportTechnology, Symbol("ext"), ext)
