...
@doc raw"""CarbonCaps
    ...
    - eligible_zones::Vector{Region} : List of regions that contribute to the carbon cap constraint.
...
Base.@kwdef mutable struct CarbonCaps <: OpenAPI.APIModel
    ...
    eligible_zones = nothing # spec type: Union{ Nothing, Vector{Region} }
