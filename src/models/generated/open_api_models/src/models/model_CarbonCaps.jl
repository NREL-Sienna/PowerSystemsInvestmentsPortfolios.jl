...
Base.@kwdef mutable struct CarbonCaps <: OpenAPI.APIModel
    ...
    function CarbonCaps(name, id, available, power_systems_type, eligible_zones, co_2_max_tons_mwh, co_2_max_mtons, pricecap, )
        ...
        return new(name, id, available, power_systems_type, eligible_zones, co_2_max_tons_mwh, co_2_max_mtons, pricecap, )
    end
end # type CarbonCaps

const _property_types_CarbonCaps = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("power_systems_type")=>"String", Symbol("eligible_zones")=>"Vector{Int64}", Symbol("co_2_max_tons_mwh")=>"Float64", Symbol("co_2_max_mtons")=>"Float64", Symbol("pricecap")=>"Float64", )
