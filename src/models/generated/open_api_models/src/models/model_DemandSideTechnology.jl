...
Base.@kwdef mutable struct DemandSideTechnology <: OpenAPI.APIModel
    ...
    function DemandSideTechnology(name, id, available, power_systems_type, technology_efficiency, price_per_unit, min_power, ramp_up_percentage, ramp_dn_percentage, )
        ...
        return new(name, id, available, power_systems_type, technology_efficiency, price_per_unit, min_power, ramp_up_percentage, ramp_dn_percentage, )
    end
end # type DemandSideTechnology

const _property_types_DemandSideTechnology = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("power_systems_type")=>"String", Symbol("technology_efficiency")=>"Float64", Symbol("price_per_unit")=>"Float64", Symbol("min_power")=>"Float64", Symbol("ramp_up_percentage")=>"Float64", Symbol("ramp_dn_percentage")=>"Float64", )
