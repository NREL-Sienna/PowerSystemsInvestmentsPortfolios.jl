...
Base.@kwdef mutable struct DemandSideTechnology <: OpenAPI.APIModel
    ...
    function DemandSideTechnology(name, id, available, region, power_systems_type, technology_efficiency, price_per_unit, min_power, max_demand_delay, max_demand_advance, demand_energy_efficiency, variable_cost_per_mwh, curtailment_cost, max_demand_curtailment, )
        ...
        OpenAPI.validate_property(DemandSideTechnology, Symbol("variable_cost_per_mwh"), variable_cost_per_mwh)
        ...
        return new(name, id, available, region, power_systems_type, technology_efficiency, price_per_unit, min_power, max_demand_delay, max_demand_advance, demand_energy_efficiency, variable_cost_per_mwh, curtailment_cost, max_demand_curtailment, )
    end
end # type DemandSideTechnology

const _property_types_DemandSideTechnology = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("region")=>"Vector{Int64}", Symbol("power_systems_type")=>"String", Symbol("technology_efficiency")=>"Float64", Symbol("price_per_unit")=>"Float64", Symbol("min_power")=>"Float64", Symbol("max_demand_delay")=>"Float64", Symbol("max_demand_advance")=>"Float64", Symbol("demand_energy_efficiency")=>"Float64", Symbol("variable_cost_per_mwh")=>"ValueCurve", Symbol("curtailment_cost")=>"ValueCurve", Symbol("max_demand_curtailment")=>"Float64", )
