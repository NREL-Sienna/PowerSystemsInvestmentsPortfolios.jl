...
Base.@kwdef mutable struct ColocatedSupplyStorageTechnology <: OpenAPI.APIModel
    ...
    function ColocatedSupplyStorageTechnology(name, id, power_systems_type, base_year, region, available, balancing_topology, capital_costs_solar, operation_costs_solar, initial_capacity_solar, capacity_limits_solar, lifetime_solar, financial_data_solar, capital_costs_wind, operation_costs_wind, initial_capacity_wind, capacity_limits_wind, lifetime_wind, financial_data_wind, capital_costs_energy, capital_costs_power, operations_costs_energy, operations_costs_power, existing_capacity_power, existing_capacity_energy, capacity_power_limits, capacity_energy_limits, duration_limits, efficiency_storage, losses_storage, lifetime_storage, financial_data_storage, maximum_inverter_capacity, minimum_inverter_capacity, capital_costs_inverter, operation_costs_inverter, inverter_efficiency, inverter_supply_ratio, )
        ...
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("initial_capacity_solar"), initial_capacity_solar)
        ...
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("financial_data_solar"), financial_data_solar)
        ...
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("initial_capacity_wind"), initial_capacity_wind)
        ...
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("financial_data_wind"), financial_data_wind)
        ...
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("operations_costs_energy"), operations_costs_energy)
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("operations_costs_power"), operations_costs_power)
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("existing_capacity_power"), existing_capacity_power)
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("existing_capacity_energy"), existing_capacity_energy)
        ...
        OpenAPI.validate_property(ColocatedSupplyStorageTechnology, Symbol("financial_data_storage"), financial_data_storage)
        ...
        return new(name, id, power_systems_type, base_year, region, available, balancing_topology, capital_costs_solar, operation_costs_solar, initial_capacity_solar, capacity_limits_solar, lifetime_solar, financial_data_solar, capital_costs_wind, operation_costs_wind, initial_capacity_wind, capacity_limits_wind, lifetime_wind, financial_data_wind, capital_costs_energy, capital_costs_power, operations_costs_energy, operations_costs_power, existing_capacity_power, existing_capacity_energy, capacity_power_limits, capacity_energy_limits, duration_limits, efficiency_storage, losses_storage, lifetime_storage, financial_data_storage, maximum_inverter_capacity, minimum_inverter_capacity, capital_costs_inverter, operation_costs_inverter, inverter_efficiency, inverter_supply_ratio, )
    end
end # type ColocatedSupplyStorageTechnology

const _property_types_ColocatedSupplyStorageTechnology = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("power_systems_type")=>"String", Symbol("base_year")=>"Int64", Symbol("region")=>"Vector{Int64}", Symbol("available")=>"Bool", Symbol("balancing_topology")=>"String", Symbol("capital_costs_solar")=>"ValueCurve", Symbol("operation_costs_solar")=>"RenewableGenerationCost", Symbol("initial_capacity_solar")=>"Float64", Symbol("capacity_limits_solar")=>"MinMax", Symbol("lifetime_solar")=>"Int64", Symbol("financial_data_solar")=>"Any", Symbol("capital_costs_wind")=>"ValueCurve", Symbol("operation_costs_wind")=>"RenewableGenerationCost", Symbol("initial_capacity_wind")=>"Float64", Symbol("capacity_limits_wind")=>"MinMax", Symbol("lifetime_wind")=>"Int64", Symbol("financial_data_wind")=>"Any", Symbol("capital_costs_energy")=>"ValueCurve", Symbol("capital_costs_power")=>"ValueCurve", Symbol("operations_costs_energy")=>"StorageCost", Symbol("operations_costs_power")=>"StorageCost", Symbol("existing_capacity_power")=>"Float64", Symbol("existing_capacity_energy")=>"Float64", Symbol("capacity_power_limits")=>"MinMax", Symbol("capacity_energy_limits")=>"MinMax", Symbol("duration_limits")=>"MinMax", Symbol("efficiency_storage")=>"InOut", Symbol("losses_storage")=>"Float64", Symbol("lifetime_storage")=>"Int64", Symbol("financial_data_storage")=>"Any", Symbol("maximum_inverter_capacity")=>"Float64", Symbol("minimum_inverter_capacity")=>"Float64", Symbol("capital_costs_inverter")=>"ValueCurve", Symbol("operation_costs_inverter")=>"ProductionVariableCostCurve", Symbol("inverter_efficiency")=>"Float64", Symbol("inverter_supply_ratio")=>"Float64", )
