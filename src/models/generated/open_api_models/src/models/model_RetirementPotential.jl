...
const _property_types_RetirementPotential = Dict{Symbol,String}(Symbol("internal")=>"InfrastructureSystemsInternal", Symbol("ext")=>"Dict", Symbol("retirement_potential")=>"Vector{PSYGenerator}", )
