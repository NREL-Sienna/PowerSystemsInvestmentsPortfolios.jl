...
**zone** | [***Union{NothingInt64Zone}**](Union{NothingInt64Zone}.md) | Zone where tech operates in | [optional] [default to nothing]
**prime_mover_type** | [***PrimeMovers**](PrimeMovers.md) | Prime mover for generator | [optional] [default to nothing]
**minimum_required_capacity** | **Float64** | Minimum required capacity for a technology | [optional] [default to nothing]
...
**gen_ID** | **Int64** | ID for individual generator | [optional] [default to nothing]
...
**down_time** | **Float64** | Minimum amount of time a resource has to remain in the shutdown state. | [optional] [default to nothing]
...
**maximum_capacity** | **Float64** | Maximum allowable installed capacity for a technology | [optional] [default to nothing]
**cluster** | **Int64** | Number of the cluster when representing multiple clusters of a given technology in a given region. | [optional] [default to nothing]
