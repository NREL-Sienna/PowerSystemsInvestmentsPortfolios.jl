...
function CarbonCaps(; name, pricecap=Inf, internal=InfrastructureSystemsInternal(), eligible_zones=Vector{Int64}(), co_2_max_tons_mwh=1, ext=Dict(), co_2_max_mtons=Vector{Int64}(), available, )
    CarbonCaps(name, pricecap, internal, eligible_zones, co_2_max_tons_mwh, ext, co_2_max_mtons, available, )
end
