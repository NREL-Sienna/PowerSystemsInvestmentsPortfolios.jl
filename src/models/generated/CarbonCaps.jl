...
function CarbonCaps(; name, internal=InfrastructureSystemsInternal(), max_tons_per_mwh=1.0, max_tons=1e8, ext=Dict(), available, eligible_regions=Vector{Region}(), )
    CarbonCaps(name, internal, max_tons_per_mwh, max_tons, ext, available, eligible_regions, )
end
