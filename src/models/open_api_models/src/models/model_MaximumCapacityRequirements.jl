...
Base.@kwdef mutable struct MaximumCapacityRequirements <: OpenAPI.APIModel
    ...
    function MaximumCapacityRequirements(name, id, available, eligible_resources, max_capacity_mw, )
...
const _property_types_MaximumCapacityRequirements = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("eligible_resources")=>"Vector{Int64}", Symbol("max_capacity_mw")=>"Float64", )
