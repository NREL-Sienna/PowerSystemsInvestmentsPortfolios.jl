...
function SupplyTechnology{T}(name, available, power_systems_type, fuel, prime_mover, capacity_factor, capital_cost, operational_cost, supplemental_attributes_container=InfrastructureSystems.SupplementalAttributesContainer(), time_series_container=InfrastructureSystems.TimeSeriesContainer(), ) where T <: PSY.Generator
    SupplyTechnology{T}(name, available, power_systems_type, fuel, prime_mover, capacity_factor, capital_cost, operational_cost, supplemental_attributes_container, time_series_container, InfrastructureSystemsInternal(), )
end
...
function SupplyTechnology{T}(; name, available, power_systems_type, fuel, prime_mover, capacity_factor, capital_cost, operational_cost, supplemental_attributes_container=InfrastructureSystems.SupplementalAttributesContainer(), time_series_container=InfrastructureSystems.TimeSeriesContainer(), internal=InfrastructureSystemsInternal(), ) where T <: PSY.Generator
    SupplyTechnology{T}(name, available, power_systems_type, fuel, prime_mover, capacity_factor, capital_cost, operational_cost, supplemental_attributes_container, time_series_container, internal, )
end
